...
namespace SocialSyncData.Migrations
{
    ...
    [Migration("20250111162700_Altered_table_relations_20251101")]
    partial class Altered_table_relations_20251101
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialSyncData.Models.PostScheduler", b =>
                {
                    ...
                    b.HasIndex("UserPostId")
                        .IsUnique()
                        .HasFilter("[UserPostId] IS NOT NULL");
            ...
            modelBuilder.Entity("SocialSyncData.Models.PostScheduler", b =>
                {
                    b.HasOne("SocialSyncData.Models.UserPosts", "UserPost")
                        .WithOne("PostScheduler")
                        .HasForeignKey("SocialSyncData.Models.PostScheduler", "UserPostId");
